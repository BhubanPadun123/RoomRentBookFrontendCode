...
const DrawerModel: React.FC<PopoverProps> = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div style={{ width: "30vw", backgroundColor: "GrayText", height: "100%" }}>
          <Typography sx={{ width: "100%", display: "flex", justifyContent: "end" }}>
